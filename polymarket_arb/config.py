...
MAX_SLIPPAGE = float(os.getenv("POLYMARKET_MAX_SLIPPAGE", "0"))
MIN_EDGE = float(os.getenv("POLYMARKET_MIN_EDGE", "0"))
MIN_LIQUIDITY = float(os.getenv("POLYMARKET_MIN_LIQUIDITY", "0"))
